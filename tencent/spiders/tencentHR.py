...
class TencenthrSpider(scrapy.Spider):
    ...
    base_url="https://hr.tencent.com/position.php?keywords=&lid=0&tid=87"
    offset=0
    ...
    def parse(self, response):
        ...
        for node in node_list:
            ...
            #获取职位链接信息存储到item中
            # node.xpath("./td[1]/a/@href").extract()[0]

            url_second=node.xpath("./td[1]/a/@href").extract()[0]
            url_second="https://hr.tencent.com/"+url_second

            item['positionLink'] =url_second
            ...
            yield scrapy.Request(url_second,meta={'item':item},callback=self.parse_second)
    ...
    def parse_second(self, response):
        ...
        item['positionInformation']=response.xpath("//ul[@class='squareli']/li/text()").extract()
        #print(len(item['positionInformation']))
        #print(item['positionInformation'])
